...
public extension UIColor{
    ...
    convenience init(colorHex: UInt){
...
public struct GMD{
    ...
    public static func primaryColor(colorType: GMDColorType, level: GMDColorPrimaryLevel = .Default) -> UIColor{
        ...
        let colorHex: UInt = getPrimaryColorData(colorType: colorType, level: level.rawValue)
    ...
    public static func accentColor(colorType: GMDColorType, level: GMDColorAccentLevel) -> UIColor?{
        ...
        guard let colorHex: UInt = getAccentColorData(colorType: colorType, level: level.rawValue) else {
            return nil
        }
    ...
    public static func textColor(colorType: GMDColorType, level: GMDColorPrimaryLevel = .Default) -> UIColor{
        ...
        return index < GMD.primaryWhiteTextColorBound(colorType: colorType) ? GMD.darkTextColor : GMD.lightTextColor
    }
    ...
    public static func textColor(colorType: GMDColorType, level: GMDColorAccentLevel) -> UIColor?{
        ...
        if level.rawValue < GMDColorType.accentCount{
            return level.rawValue < GMD.accentWhiteTextColorBound(colorType: colorType) ?? 1 ? GMD.darkTextColor : GMD.lightTextColor
        }
    ...
    public static var lightTextColor: UIColor = UIColor.white
